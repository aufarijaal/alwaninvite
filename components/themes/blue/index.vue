    ...
    <div id="theme-blue" class="min-h-screen bg-slate-900 text-white">
                ...
                <div class="grid grid-cols-4 gap-3">
                    <div v-for="unit in countdown" :key="unit.label"
                        ...
                        <div class="text-3xl font-bold text-white tabular-nums" style="font-family: Georgia, serif;">{{
                            unit.value }}</div>
                        <div class="text-blue-300/50 text-xs font-sans mt-1 tracking-widest uppercase">{{ unit.label }}
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div v-for="event in invitation?.events" :key="event.type" data-aos="fade-up" data-aos-delay="100"
                        ...
                        <div class="flex items-start gap-4">
                            ...
                            <div
                                ...
                                <svg v-if="event.type === 'ceremony'" class="w-5 h-5 text-blue-300" fill="none"
                                    stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"
                                        d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.746 0 3.332.477 4.5 1.253v13C19.832 18.477 18.246 18 16.5 18c-1.746 0-3.332.477-4.5 1.253" />
                                </svg>
                                <svg v-else class="w-5 h-5 text-blue-300" fill="none" stroke="currentColor"
                                    viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"
        ...
        <section v-if="invitation?.livestream_is_active" data-aos="fade-up" class="bg-slate-900 py-16 px-6">
            <div class="max-w-sm mx-auto text-center">
                ...
                <div class="bg-blue-900/30 border border-blue-700/30 rounded-2xl p-6 mb-6">
                    <div class="flex items-center justify-center gap-3 mb-4">
                        ...
                        <div v-else class="w-10 h-10 rounded-full bg-blue-700 flex items-center justify-center">
                    ...
                    <p class="text-blue-300/60 text-sm font-sans mt-0.5">Pukul {{
        ...
        <section v-if="invitation?.gifts?.length" data-aos="fade-up"
            ...
            <div class="max-w-sm mx-auto">
                <div class="text-center mb-10">
                    ...
                    <p class="text-blue-300/50 text-sm font-sans">Doa restu Anda adalah hadiah terbaik. Namun bagi yang
                    ...
                    <div v-for="gift in invitation.gifts" :key="gift.account_number" data-aos="zoom-in"
                        ...
                        <div class="flex items-center gap-3 mb-3">
                            <div
                                ...
                                <svg v-if="gift.type === 'bank'" class="w-5 h-5 text-blue-300" fill="none"
                                    stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"
                            ...
                            <div>
                                <p class="text-blue-300/50 text-xs font-sans capitalize">{{ gift.type === 'bank' ?
                                    'Rekening Bank' : 'Dompet Digital' }}</p>
                                <p class="text-white font-semibold text-sm">{{ gift.provider }}</p>
                            </div>
                        </div>
                        <div class="bg-blue-950/60 rounded-xl p-3 flex items-center justify-between gap-3">
                            <div class="min-w-0">
        ...
        <section data-aos="fade-up" class="bg-blue-950 py-20 px-6">
            <div class="max-w-sm mx-auto">
                ...
                <form v-if="guestValidated === true" @submit.prevent="submitWish"
                    ...
                    <div class="space-y-4">
                        <div>
                            <label class="block text-xs text-blue-300/60 font-sans mb-1.5">Nama</label>
                        ...
                        <div>
                            <label class="block text-xs text-blue-300/60 font-sans mb-1.5">Kehadiran</label>
                        ...
                        <div>
                            <label class="block text-xs text-blue-300/60 font-sans mb-1.5">Ucapan &amp; Doa</label>
                            <textarea v-model="wishForm.message" placeholder="Tuliskan doa dan ucapan Anda..." rows="3"
                                required maxlength="500"
                                class="w-full bg-blue-950/60 border border-blue-700/40 rounded-xl px-4 py-2.5 text-white placeholder-blue-300/30 font-sans text-sm focus:outline-none focus:border-blue-400/60 transition-colors resize-none"></textarea>
                        </div>
                    ...
                    <div v-for="wish in paginatedWishes" :key="wish.id"
                        ...
                        <div class="flex items-start gap-3">
                            ...
                            <div class="flex-1 min-w-0">
                                ...
                                <p class="text-blue-300/70 text-sm font-sans leading-relaxed">{{ wish.message }}</p>
                            </div>
                        </div>
                    </div>
                </div>
...
const attendanceBadgeClass = (val: string) =>
    ...
    } as Record<string, string>)[val] ?? 'bg-blue-500/20 text-blue-300'
</script>
