    ...
    <div id="theme-green" class="min-h-screen bg-stone-950 text-white">
        ...
        <section
            ...
            <div class="absolute inset-0 pointer-events-none overflow-hidden">
                <div class="absolute -top-32 -left-32 w-96 h-96 bg-emerald-600/10 rounded-full blur-3xl"></div>
                <div class="absolute -bottom-32 -right-32 w-96 h-96 bg-lime-400/10 rounded-full blur-3xl"></div>
                <div
            ...
            <div class="relative z-10 max-w-sm mx-auto w-full">
                ...
                <div v-motion :initial="{ opacity: 0 }"
                    ...
                    <p class="text-emerald-200/60 text-xs tracking-[0.3em] uppercase font-sans mb-10">Undangan
                        Pernikahan
                    </p>
                </div>
                ...
                <div v-motion :initial="{ opacity: 0, y: 20 }"
                    ...
                    <p class="text-emerald-100/80 text-xs font-sans tracking-widest">{{ formatDate(mainEventDate) }}</p>
                    <div class="w-1.5 h-1.5 rounded-full bg-amber-400"></div>
                </div>
                ...
                <div v-motion :initial="{ opacity: 0, y: 30 }"
                    ...
                    <div v-if="props.guest" class="text-center mb-1">
                        <p class="text-emerald-300/50 text-xs font-sans tracking-widest uppercase mb-1">Kepada Yth.</p>
        ...
        <section data-aos="fade-up" class="bg-stone-950 py-20 px-6">
            <div class="max-w-sm mx-auto text-center">
                ...
                <div data-aos="fade-right" data-aos-delay="100" class="mb-10">
                    ...
                    <p class="text-emerald-300/50 text-xs font-sans tracking-widest uppercase mb-2">Mempelai Pria</p>
                    <h2 class="text-xl font-bold text-white mb-1" style="font-family: Georgia, serif;">{{
                        invitation?.groom_fullname }}</h2>
                    <p class="text-emerald-300/70 text-sm font-sans">{{ invitation?.groom_info_1 }}</p>
                    <p class="text-emerald-300/50 text-xs font-sans mt-0.5">{{ invitation?.groom_info_2 }}</p>
                ...
                <div class="flex items-center gap-4 mb-10">
                    <div class="h-px flex-1 bg-gradient-to-r from-transparent via-emerald-700/40 to-transparent"></div>
                ...
                <div data-aos="fade-left" data-aos-delay="200">
                    ...
                    <p class="text-emerald-300/50 text-xs font-sans tracking-widest uppercase mb-2">Mempelai Wanita</p>
                    <h2 class="text-xl font-bold text-white mb-1" style="font-family: Georgia, serif;">{{
                        invitation?.bride_fullname }}</h2>
                    <p class="text-emerald-300/70 text-sm font-sans">{{ invitation?.bride_info_1 }}</p>
                    <p class="text-emerald-300/50 text-xs font-sans mt-0.5">{{ invitation?.bride_info_2 }}</p>
        ...
        <!-- ===== COUNTDOWN ===== -->
        <section data-aos="fade-up" class="bg-gradient-to-b from-stone-950 to-emerald-950 py-16 px-6">
            <div class="max-w-sm mx-auto text-center">
                    ...
                    <div v-for="event in invitation?.events" :key="event.type" data-aos="fade-up" data-aos-delay="100"
                        ...
                        <div class="flex items-start gap-4">
                            ...
                            <div
                                ...
                                <svg v-if="event.type === 'ceremony'" class="w-5 h-5 text-emerald-300" fill="none"
                                    stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"
                                        d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.746 0 3.332.477 4.5 1.253v13C19.832 18.477 18.246 18 16.5 18c-1.746 0-3.332.477-4.5 1.253" />
                                </svg>
                                <svg v-else class="w-5 h-5 text-emerald-300" fill="none" stroke="currentColor"
                                    viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"
        ...
        <!-- ===== LIVESTREAM ===== -->
        <section v-if="invitation?.livestream_is_active" data-aos="fade-up" class="bg-stone-950 py-16 px-6">
            <div class="max-w-sm mx-auto text-center">
                ...
                <div class="bg-green-900/30 border border-green-700/30 rounded-2xl p-6 mb-6">
                    <div class="flex items-center justify-center gap-3 mb-4">
                        ...
                        <div v-else class="w-10 h-10 rounded-full bg-emerald-700 flex items-center justify-center">
                    ...
                    <p class="text-emerald-300/60 text-sm font-sans mt-0.5">Pukul {{
        ...
        <section v-if="invitation?.gifts?.length" data-aos="fade-up"
            ...
            <div class="max-w-sm mx-auto">
                <div class="text-center mb-10">
                    ...
                    <p class="text-emerald-300/50 text-sm font-sans">Doa restu Anda adalah hadiah terbaik. Namun bagi
                        yang
                ...
                <div class="space-y-4">
                    <div v-for="gift in invitation.gifts" :key="gift.account_number" data-aos="zoom-in"
                        data-aos-delay="100" class="bg-green-900/30 border border-green-700/30 rounded-2xl p-5">
                        <div class="flex items-center gap-3 mb-3">
                            <div
                                class="w-10 h-10 rounded-xl bg-green-800/60 border border-green-600/30 flex items-center justify-center">
                                <svg v-if="gift.type === 'bank'" class="w-5 h-5 text-emerald-300" fill="none"
                                    stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"
                            ...
                            <div>
                                <p class="text-emerald-300/50 text-xs font-sans capitalize">{{ gift.type === 'bank' ?
            ...
            <div class="max-w-sm mx-auto">
                <div class="text-center" :class="guestValidated === true ? 'mb-10' : 'mb-6'">
                    ...
                    <template v-if="guestValidated === true">
                        ...
                        <p class="text-emerald-300/50 text-sm font-sans">Sampaikan doa dan ucapan terbaik untuk kedua
                            mempelai</p>
                    </template>
                </div>
                ...
                <form v-if="guestValidated === true" @submit.prevent="submitWish"
                    ...
                    <div class="space-y-4">
                        <div>
                            <label class="block text-xs text-emerald-300/60 font-sans mb-1.5">Nama</label>
                        ...
                        <div>
                            <label class="block text-xs text-emerald-300/60 font-sans mb-1.5">Kehadiran</label>
                        ...
                        <div>
                            <label class="block text-xs text-emerald-300/60 font-sans mb-1.5">Ucapan &amp; Doa</label>
                            <textarea v-model="wishForm.message" placeholder="Tuliskan doa dan ucapan Anda..." rows="3"
                                required maxlength="500"
                                class="w-full bg-emerald-950/60 border border-green-700/40 rounded-xl px-4 py-2.5 text-white placeholder-emerald-300/30 font-sans text-sm focus:outline-none focus:border-emerald-400/60 transition-colors resize-none"></textarea>
                        </div>
                ...
                <div v-if="wishAutoReply"
                    ...
                    <p class="text-emerald-100 text-sm font-sans leading-relaxed">{{ wishAutoReply }}</p>
                </div>

                <!-- Wish List -->
                <div v-if="wishes.length" class="space-y-4">
                    <div v-for="wish in paginatedWishes" :key="wish.id"
                        class="bg-green-900/20 border border-green-700/20 rounded-2xl p-5">
                        <div class="flex items-start gap-3">
                            ...
                            <div class="flex-1 min-w-0">
                                ...
                                <p class="text-emerald-300/70 text-sm font-sans leading-relaxed">{{ wish.message }}</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div v-else class="text-center py-10">
                    <p class="text-emerald-300/50 text-sm font-sans">Belum ada ucapan. Jadilah yang pertama memberikan
                        doa dan ucapan!
                        🤍</p>
                </div>
                ...
                <div v-if="wishTotalPages > 1" class="flex items-center justify-center gap-3 mt-6">
                    ...
                    <span class="text-emerald-300/50 text-xs font-sans">{{ wishPage }} / {{ wishTotalPages }}</span>
        ...
        <!-- ===== FOOTER ===== -->
        <footer data-aos="fade-up" class="bg-stone-950 py-10 px-6 text-center border-t border-emerald-900/30">
            <p class="text-emerald-300/40 text-xs font-sans mb-1">Dibuat dengan ♥ menggunakan</p>
            <p class="text-emerald-400/70 text-sm font-semibold font-sans">Alwan Invite</p>
        </footer>
...
const openInvitation = () => {
    ...
    const next = document.getElementById('theme-green')?.querySelector('section:nth-child(2)')
...
const attendanceBadgeClass = (val: string) =>
    ...
    } as Record<string, string>)[val] ?? 'bg-emerald-500/20 text-emerald-300'
</script>
