<template>
    <div id="theme-slate" class="min-h-screen bg-zinc-950 text-white">
        ...
        <section
            ...
            <div class="relative z-10 max-w-sm mx-auto w-full">
                ...
                <div v-motion :initial="{ opacity: 0 }"
                    ...
                    <p class="text-slate-400/50 text-xs tracking-[0.3em] uppercase font-sans mb-10">Undangan Pernikahan
                    </p>
                </div>
        ...
        <!-- ===== COUNTDOWN ===== -->
        <section data-aos="fade-up" class="bg-gradient-to-b from-zinc-950 to-slate-900 py-16 px-6">
            <div class="max-w-sm mx-auto text-center">
                    ...
                    <div v-for="event in invitation?.events" :key="event.type" data-aos="fade-up" data-aos-delay="100"
                        ...
                        <div class="flex items-start gap-4">
                            ...
                            <div class="flex-1 min-w-0">
                                ...
                                <p class="text-slate-300/90 text-sm font-medium font-sans mb-0.5">{{
                                ...
                                <p class="text-slate-400/60 text-sm font-sans leading-relaxed mb-3">{{
        ...
        <!-- ===== LIVESTREAM ===== -->
        <section v-if="invitation?.livestream_is_active" data-aos="fade-up" class="bg-zinc-950 py-16 px-6">
            <div class="max-w-sm mx-auto text-center">
            ...
            <div class="max-w-sm mx-auto">
                ...
                <div class="space-y-4">
                    <div v-for="gift in invitation.gifts" :key="gift.account_number" data-aos="zoom-in"
                        data-aos-delay="100" class="bg-slate-800/30 border border-slate-600/30 rounded-2xl p-5">
        ...
        <section data-aos="fade-up" class="bg-slate-900 py-20 px-6">
            <div class="max-w-sm mx-auto">
                <div class="text-center" :class="guestValidated === true ? 'mb-10' : 'mb-6'">
                    <p class="text-slate-400/50 text-xs tracking-[0.3em] uppercase font-sans"
                ...
                <div v-if="wishAutoReply"
                    ...
                    <p class="text-slate-200 text-sm font-sans leading-relaxed">{{ wishAutoReply }}</p>
                </div>
                ...
                <div v-else class="text-center py-10">
                    <p class="text-slate-400/50 text-sm font-sans">Belum ada ucapan.
                    </p>
                </div>
        ...
        <!-- ===== FOOTER ===== -->
        <footer data-aos="fade-up" class="bg-zinc-950 py-10 px-6 text-center border-t border-slate-700/30">
