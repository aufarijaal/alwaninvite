  ...
  <div id="theme-slate" class="min-h-screen bg-zinc-950 text-white">
    ...
    >
      ...
      <div class="absolute inset-0 pointer-events-none overflow-hidden">
        <div
          class="absolute -top-32 -left-32 w-96 h-96 bg-slate-600/10 rounded-full blur-3xl"
        ></div>
        <div
          class="absolute -bottom-32 -right-32 w-96 h-96 bg-sky-600/10 rounded-full blur-3xl"
        ></div>
        <div
      ...
      <div class="relative z-10 max-w-sm mx-auto w-full">
        ...
        >
          ...
          <svg
            class="w-5 h-5 text-slate-400/50"
            viewBox="0 0 24 24"
            fill="currentColor"
          >
            <path
        ...
        >
          <SvgBismillahWord class="mx-auto w-32 text-slate-300" />
          <p
            class="text-slate-400/50 text-xs tracking-[0.3em] uppercase font-sans mb-10"
          >
            Undangan Pernikahan
          </p>
        </div>
        ...
        >
          ...
          <p class="text-slate-200/80 text-xs font-sans tracking-widest">
        ...
        >
          <div v-if="props.guest" class="text-center mb-1">
            <p
              class="text-slate-400/50 text-xs font-sans tracking-widest uppercase mb-1"
            >
              Kepada Yth.
            </p>
    ...
    <!-- ===== COUPLE SECTION ===== -->
    <section data-aos="fade-up" class="bg-zinc-950 py-20 px-6">
      <div class="max-w-sm mx-auto text-center">
        <p
          class="text-slate-400/50 text-xs tracking-[0.3em] uppercase font-sans mb-12"
        >
          Yang Berbahagia
        </p>
        ...
        <div data-aos="fade-right" data-aos-delay="100" class="mb-10">
          ...
          <p
            class="text-slate-400/50 text-xs font-sans tracking-widest uppercase mb-2"
          >
            Mempelai Pria
          </p>
          <h2
          ...
          <p class="text-slate-300/70 text-sm font-sans">
            {{ invitation?.groom_info_1 }}
          </p>
          <p class="text-slate-400/50 text-xs font-sans mt-0.5">
            {{ invitation?.groom_info_2 }}
          </p>
          <p
            v-if="invitation?.groom_info_3"
            class="text-sky-400/60 text-xs font-sans mt-1"
          >
        ...
        <div class="flex items-center gap-4 mb-10">
          <div
            class="h-px flex-1 bg-gradient-to-r from-transparent via-slate-600/40 to-transparent"
          ></div>
    ...
    <section
      data-aos="fade-up"
      class="bg-gradient-to-b from-zinc-950 to-slate-900 py-16 px-6"
    >
      <div class="max-w-sm mx-auto text-center">
        <p
          class="text-slate-400/50 text-xs tracking-[0.3em] uppercase font-sans mb-8"
        >
          Menuju Hari Bahagia
        </p>
        <div class="grid grid-cols-4 gap-3">
          ...
          >
            ...
            <div
              class="text-slate-400/50 text-xs font-sans mt-1 tracking-widest uppercase"
            >
              {{ unit.label }}
            </div>
          </div>
    ...
    <section data-aos="fade-up" class="bg-slate-900 py-20 px-6">
      <div class="max-w-sm mx-auto">
        <div class="text-center mb-12">
          <p
            class="text-slate-400/50 text-xs tracking-[0.3em] uppercase font-sans mb-3"
          >
            Rangkaian Acara
          </p>
          <h2
          ...
          >
            <div class="flex items-start gap-4">
              ...
              <div class="flex-1 min-w-0">
                ...
                <p
                  class="text-slate-300/90 text-sm font-medium font-sans mb-0.5"
                >
                  {{ formatEventDate(event.start_time) }}
                </p>
                <p class="text-slate-300/70 text-sm font-medium font-sans mb-3">
                ...
                <p
                  class="text-slate-400/60 text-sm font-sans leading-relaxed mb-3"
                >
    ...
    >
      <div class="max-w-sm mx-auto text-center">
        ...
        <div
          class="bg-slate-800/30 border border-slate-600/30 rounded-2xl p-6 mb-6"
        >
          ...
          <p class="text-slate-300/60 text-sm font-sans mt-0.5">
    ...
    >
      <div class="max-w-sm mx-auto">
        <div class="text-center mb-10">
          ...
          <p class="text-slate-300/50 text-sm font-sans">
        ...
        <div class="space-y-4">
          ...
          >
            <div class="flex items-center gap-3 mb-3">
              ...
              <div>
                <p class="text-slate-400/50 text-xs font-sans capitalize">
                  {{
            ...
            <div
              class="bg-zinc-950/60 rounded-xl p-3 flex items-center justify-between gap-3"
            >
              <div class="min-w-0">
                <p class="text-slate-400/50 text-xs font-sans mb-0.5 truncate">
                  {{ gift.account_name }}
                </p>
                <p
    ...
    <section data-aos="fade-up" class="bg-slate-900 py-20 px-6">
      <div class="max-w-sm mx-auto">
        ...
        >
          <p
            class="text-slate-400/50 text-xs tracking-[0.3em] uppercase font-sans"
        ...
        >
          <div class="space-y-4">
            <div>
              <label class="block text-xs text-slate-400/60 font-sans mb-1.5"
                >Nama</label
              >
              <input
            ...
            <div>
              ...
              <textarea
                ...
                required
                maxlength="500"
                class="w-full bg-zinc-950/60 border border-slate-600/40 rounded-xl px-4 py-2.5 text-white placeholder-slate-400/30 font-sans text-sm focus:outline-none focus:border-slate-400/60 transition-colors resize-none"
              ></textarea>
            </div>
            <button
              type="submit"
        ...
        <div
          v-if="wishAutoReply"
          class="bg-slate-800/40 border border-slate-500/30 rounded-xl p-4 mb-6 text-center"
        >
          <p class="text-slate-200 text-sm font-sans leading-relaxed">
            {{ wishAutoReply }}
          </p>
        </div>
        ...
        <div
          v-if="wishes.length"
          class="bg-slate-800/20 border border-slate-600/20 rounded-2xl overflow-hidden"
        >
          <div
          ...
          >
            ...
            <p class="text-slate-300/70 text-sm font-sans leading-relaxed">
        ...
        <div v-else class="text-center py-10">
          <p class="text-slate-400/50 text-sm font-sans">Belum ada ucapan.</p>
        </div>
        ...
        >
          ...
          <span class="text-slate-400/50 text-xs font-sans"
    ...
    <footer
      data-aos="fade-up"
      class="bg-zinc-950 py-10 px-6 text-center border-t border-slate-700/30"
    >
      <p class="text-slate-400/40 text-xs font-sans mb-1">
        Dibuat dengan ♥ menggunakan
      </p>
      <p class="text-slate-400/70 text-sm font-semibold font-sans">
        Alwan Invite
      </p>
    </footer>
...
const attendanceBadgeClass = (val: string) =>
  ...
  )[val] ?? "bg-slate-500/20 text-slate-300";
</script>
